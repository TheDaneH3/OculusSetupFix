...
if (!(Test-Path "HKCU:\SOFTWARE\Oculus VR, LLC")) {
    ...
    New-Item -Path "HKCU:\SOFTWARE" -Name "Oculus VR, LLC"
...
if (!(Test-Path "HKCU:\SOFTWARE\Oculus VR, LLC\Oculus")) {
    ...
    New-Item -Path "HKCU:\SOFTWARE\Oculus VR, LLC" -Name "Oculus"
...
if (!(Test-Path "HKCU:\SOFTWARE\Oculus VR, LLC\Oculus\Libraries")) {
    ...
    New-Item -Path "HKCU:\SOFTWARE\Oculus VR, LLC\Oculus" -Name "Libraries"
